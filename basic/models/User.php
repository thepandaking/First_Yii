...
class User extends \app\core\base\BaseActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['username', 'auth_key', 'password_hash','password', 'email', 'created_at', 'updated_at'], 'required'],
    ...
    public function scenarios(){
        ...
        $parent['login'] = ['username','password'];//登陆场景
        $parent['register'] = ['username','password','email'];//注册场景
        return $parent;
    }
